        ...
        <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24 relative z-10 bg-white shadow-2xl">
            ...
            <div class="mx-auto w-full max-w-md lg:w-96 mt-12 lg:mt-0">
                ...
                <div class="mt-8">
                    ...
                    <div class="mt-6">
                       <a href="{{ route('google.login') }}" class="flex w-full items-center justify-center gap-3 rounded-xl bg-white px-3 py-2.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-blue-200 hover:bg-blue-50 focus-visible:ring-transparent transition-colors">
