...
<body class="flex h-screen overflow-hidden text-gray-800">
        ...
        <header class="h-20 bg-white/90 backdrop-blur-md border-b border-blue-100 flex items-center justify-between px-6 xl:px-10 sticky top-0 z-10 shadow-sm">
            ...
            <div class="flex items-center gap-4">
                <div class="flex items-center gap-3 pl-4 border-l border-blue-100">
                    <img src="https://ui-avatars.com/api/?name={{ Auth::user()->name ?? 'Pasien' }}&background=2563eb&color=fff" class="w-10 h-10 rounded-full shadow-sm border border-blue-200">
                    <div class="hidden md:block text-right">
                        <p class="text-sm font-bold text-blue-900 truncate">{{ Auth::user()->name ?? 'Pasien' }}</p>
                        <p class="text-xs text-blue-500 font-semibold truncate">Pasien Aktif</p>
                    </div>
                </div>
            </div>
        </header>
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar p-6 xl:p-10 pb-24 relative">
            <div id="view-dashboard" class="view-section fade-in">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div>
                        <h1 class="text-3xl font-extrabold text-blue-900 tracking-tight">Halo, {{ Auth::user()->name ?? 'Pasien' }}! 👋</h1>
                        <p class="text-blue-500 font-medium mt-1">Perjalanan pemulihan Anda berjalan sangat baik. Tetap semangat!</p>
                    </div>
                    <div class="flex items-center bg-white p-2.5 rounded-2xl shadow-sm border border-blue-100 w-max">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-black text-gray-800 leading-none mt-0.5">5 Hari <span class="text-sm font-semibold text-yellow-500">Beruntun</span></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-blue-900 rounded-3xl p-1.5 shadow-xl mb-8 relative overflow-hidden">
                    ...
                    <div class="bg-blue-800/80 backdrop-blur-md rounded-[1.4rem] p-6 md:p-8 relative border border-blue-700 flex flex-col md:flex-row md:items-center justify-between gap-8">
                        <div class="flex-1">
                            ...
                            <h2 class="text-3xl md:text-4xl font-extrabold text-white mb-2 tracking-tight">Terapi Ekstensi Lutut</h2>
                            <p class="text-blue-200 font-medium md:text-lg max-w-md">Instruksi: Duduk tegak di kursi, luruskan lutut Anda ke depan secara perlahan, tahan, lalu turunkan.</p>
                        </div>
                        ...
                        <div class="bg-blue-900/50 rounded-2xl p-4 md:p-6 w-full md:w-auto border border-blue-700 shrink-0">
                            <div class="flex items-center justify-center gap-6 mb-6">
                                <div class="text-center">
                                    ...
                                    <p class="text-3xl font-black text-white">15<span class="text-base text-blue-400 ml-1">Reps</span></p>
                                </div>
                            ...
                            <button class="btnStartAiCamera flex items-center justify-center w-full bg-green-500 hover:bg-green-400 text-green-900 font-black py-4 px-6 rounded-xl transition-all shadow-lg shadow-green-500/30 cursor-pointer">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-2xl p-6 border border-blue-100 shadow-sm flex flex-col justify-between">
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-black text-gray-900">92<span class="text-xl text-gray-400">%</span></p>
                            <div class="w-full bg-blue-50 h-2.5 rounded-full mt-4">
                                <div class="bg-green-500 h-2.5 rounded-full relative" style="width: 92%"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="divide-y divide-blue-50">
                        <div class="p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-blue-50/50 transition-colors">
                            <div class="flex items-start sm:items-center gap-4">
                                ...
                                <div>
                                    <h4 class="font-extrabold text-blue-900 text-lg">Tekuk Siku (Bicep Curl)</h4>
                            ...
                            <div class="flex sm:flex-col items-center sm:items-end justify-between sm:justify-center pt-4 sm:pt-0 border-t sm:border-t-0 border-blue-50">
                                <div class="text-right">
                                    ...
                                    <p class="font-black text-xl text-blue-900">15/15 <span class="text-sm text-gray-500 font-bold">Reps</span></p>
                                </div>
                                <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-extrabold bg-green-100 text-green-800 mt-0 sm:mt-2">
                                    98% Akurasi
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-blue-50/50 transition-colors">
                            <div class="flex items-start sm:items-center gap-4">
                                <div class="w-14 h-14 rounded-2xl bg-yellow-50 flex items-center justify-center shrink-0 border border-yellow-200 text-yellow-600">
                                ...
                                <div>
                                    <h4 class="font-extrabold text-blue-900 text-lg">Ekstensi Lutut</h4>
                                    <div class="flex items-center gap-3 mt-1">
                                        <span class="text-xs font-bold text-gray-500 bg-gray-100 px-2 py-0.5 rounded flex items-center">
                                            <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                                            21 Feb, 10:00
                            ...
                            <div class="flex sm:flex-col items-center sm:items-end justify-between sm:justify-center pt-4 sm:pt-0 border-t sm:border-t-0 border-blue-50">
                                <div class="text-right">
                                    <p class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-0.5">Pencapaian</p>
                                    <p class="font-black text-xl text-blue-900">7/15 <span class="text-sm text-gray-500 font-bold">Reps</span></p>
                                </div>
                                <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-extrabold bg-yellow-100 text-yellow-800 mt-0 sm:mt-2">
                                    65% Akurasi
                                </span>
                            </div>
                        </div>
            ...
            <div id="view-teleconsultation" class="view-section hidden fade-in h-[calc(100vh-180px)]">
                <div class="flex h-full bg-gray-900 rounded-2xl shadow-xl overflow-hidden relative flex flex-col justify-between" id="videoContainer">
                    ...
                    <div class="absolute bottom-24 right-6 w-32 md:w-48 h-48 md:h-32 bg-black rounded-xl border-2 border-gray-700 overflow-hidden shadow-2xl z-10">
                        <img src="https://ui-avatars.com/api/?name=Dokter+Rizqi&background=2563eb&color=fff" class="w-full h-full object-cover">
                    </div>
    ...
    <div id="patientChatBox" class="fixed bottom-24 right-6 w-80 sm:w-96 bg-white rounded-2xl shadow-2xl border border-blue-100 hidden flex-col overflow-hidden z-50 h-[450px]">
        <div class="bg-blue-600 p-4 text-white flex justify-between items-center">
            ...
            <button id="closePatientChat" class="text-blue-200 hover:text-white"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button>
        </div>
        ...
        <form id="patientChatForm" class="p-3 bg-white border-t border-blue-50 flex gap-2">
            ...
            <button type="submit" class="bg-blue-600 text-white p-2 rounded-xl hover:bg-blue-700"><svg class="w-4 h-4 transform rotate-90" fill="currentColor" viewBox="0 0 20 20"><path d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l5-1.429A1 1 0 009 15.571V11a1 1 0 112 0v4.571a1 1 0 00.725.962l5 1.428a1 1 0 001.17-1.408l-7-14z"></path></svg></button>
        </form>
    </div>
    ...
    <div id="exerciseOverlay" class="hidden fixed inset-0 z-[100] bg-slate-900 flex flex-col h-screen overflow-hidden">
        <div class="flex items-center justify-between p-4 bg-slate-800 border-b border-slate-700">
            <div class="flex items-center gap-3 text-white">
                ...
                <h2 class="font-bold text-lg">Terapi Ekstensi Lutut</h2>
            </div>
        ...
        <div class="flex-1 relative bg-black flex items-center justify-center overflow-hidden">
            <div id="loadingCam" class="absolute inset-0 flex flex-col items-center justify-center bg-slate-900 z-10">
                ...
                <p class="text-white font-medium">Menyiapkan AI Pose Tracking...</p>
            </div>
                ...
                <div class="flex flex-col md:flex-row justify-between items-center md:items-end max-w-4xl mx-auto gap-6 pointer-events-auto">
                    <div class="flex gap-4 w-full md:w-auto justify-center md:justify-start">
                        <div class="bg-slate-800/80 backdrop-blur border border-slate-600 p-4 rounded-2xl min-w-[110px] text-center shadow-lg">
                            ...
                            <p class="text-4xl font-black text-white" id="repCount">0<span class="text-lg text-slate-500 ml-1">/15</span></p>
                        </div>
                        <div class="bg-slate-800/80 backdrop-blur border border-slate-600 p-4 rounded-2xl min-w-[110px] text-center shadow-lg hidden sm:block">
                            <p class="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Sudut Lutut</p>
                            <p class="text-4xl font-black text-white" id="angleCount">0&deg;</p>
                        </div>
                    </div>
                    
                    <div class="flex-1 px-2 text-center w-full">
                        <p id="feedbackText" class="text-2xl sm:text-3xl font-black text-white drop-shadow-lg transition-colors">Bersiaplah...</p>
                    </div>
                    ...
                    <button id="btnStopExercise" class="w-full md:w-auto bg-rose-500 hover:bg-rose-600 text-white font-bold py-4 px-8 rounded-2xl shadow-lg transition-colors flex items-center justify-center gap-2 border border-rose-400 cursor-pointer">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8 7a1 1 0 00-1 1v4a1 1 0 001 1h4a1 1 0 00-1-1H8z" clip-rule="evenodd"></path></svg>
                        Selesai Latihan
                    </button>
                </div>
            </div>
    ...
    <script>
        function showToast(message, type = 'success') {
            ...
            toast.innerHTML = `<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="${type === 'success' ? 'M5 13l4 4L19 7' : 'M6 18L18 6M6 6l12 12'}"></path></svg>${message}`;
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            navBtns.forEach(btn => {
                btn.addEventListener('click', () => {
                    ...
                    if(targetView) {
                        ...
                        if(targetId === 'view-teleconsultation') startTeleCamera();
                        else stopTeleCamera();
                    }
                });
            });
            ...
            .catch(err => console.error('Error:', err));
                        ...
                        `;
                        pChatArea.insertAdjacentHTML('beforeend', docMsg);
                        pChatInput.value = '';
                        pChatArea.scrollTop = pChatArea.scrollHeight;
                    });
                });
            ...
            function startTeleCamera() {
                ...
                .then(stream => {
                    teleStream = stream;
                    if(teleVideo) teleVideo.srcObject = stream;
                    showToast('Terhubung ke sesi telekonsultasi');
                })
                .catch(err => {
                    console.error("Camera error:", err);
                    showToast('Gagal akses kamera untuk telekonsultasi', 'error');
                });
            }

            function stopTeleCamera() {
                if(teleStream) {
                    teleStream.getTracks().forEach(track => track.stop());
                    teleStream = null;
                }
                if(teleVideo) teleVideo.srcObject = null;
            }
                ...
                btnToggleMic.addEventListener('click', () => {
                    if(teleStream) {
                        ...
                        if(audioTrack) {
                            ...
                            if(isMicOn) {
                                btnToggleMic.classList.remove('bg-red-600'); btnToggleMic.classList.add('bg-gray-700/80');
                                showToast('Mikrofon aktif');
                            } else {
                                btnToggleMic.classList.remove('bg-gray-700/80'); btnToggleMic.classList.add('bg-red-600');
                ...
                btnToggleCam.addEventListener('click', () => {
                    if(teleStream) {
                        ...
                        if(videoTrack) {
                            ...
                            if(isCamOn) {
                                btnToggleCam.classList.remove('bg-red-600'); btnToggleCam.classList.add('bg-gray-700/80');
                                showToast('Kamera aktif');
                            } else {
                                btnToggleCam.classList.remove('bg-gray-700/80'); btnToggleCam.classList.add('bg-red-600');
            ...
            function speakAI(text, priority = false) {
                ...
                utterance.rate = 1.1;
                utterance.onend = () => { isSpeakingAI = false; };
            ...
            function onResults(results) {
                if(loadingCam && !loadingCam.classList.contains('hidden')) {
                    ...
                    speakAI("Kamera aktif. Silakan luruskan lutut Anda.", true);
                }
                ...
                if (results.poseLandmarks) {
                    ...
                    if(hip.visibility > 0.5 && knee.visibility > 0.5 && ankle.visibility > 0.5) {
                        ...
                        if(angleCountEl) angleCountEl.innerHTML = `${Math.round(currentAngle)}&deg;`;
                        ...
                        if (currentAngle > 160) {
                            if (stage === 'down') {
                                ...
                                if(feedbackText) {
                                    feedbackText.innerText = "Bagus! Pertahankan.";
                                    feedbackText.className = "text-2xl sm:text-3xl font-black text-emerald-400 drop-shadow-md";
                                }
                                reps++;
                                if(repCountEl) repCountEl.innerHTML = `${reps}<span class="text-lg text-slate-500 ml-1">/${targetReps}</span>`;
                        ...
                        if(knee.y < hip.y - 0.1) {
                            if(feedbackText) {
                                feedbackText.innerText = "Salah! Posisi tubuh tidak stabil.";
                                feedbackText.className = "text-2xl sm:text-3xl font-black text-rose-500 drop-shadow-md";
                            }
                            skeletonColor = '#f43f5e';
                            speakAI("Salah, perbaiki posisi duduk Anda");
                        }
                    } else {
                        if(feedbackText) {
                            feedbackText.innerText = "Pastikan seluruh kaki terlihat";
                    ...
                    drawLandmarks(canvasCtx, results.poseLandmarks, {color: '#ffffff', lineWidth: 4, radius: 6});
                }
                ...
                if(reps >= targetReps && isCameraRunning) {
                    ...
                    speakAI("Latihan selesai, kerja bagus!", true);
                    setTimeout(() => stopAIExercise(), 2000);
                }
            }

            function startAIExercise() {
                mainDashboardLayout.classList.add('hidden');
                if(exerciseOverlay) exerciseOverlay.classList.remove('hidden');
                if(loadingCam) loadingCam.classList.remove('hidden');
                
                reps = 0;
                stage = 'down';
                if(repCountEl) repCountEl.innerHTML = `0<span class="text-lg text-slate-500 ml-1">/${targetReps}</span>`;
            ...
            function stopAIExercise() {
                ...
                if(exerciseOverlay) exerciseOverlay.classList.add('hidden');
                mainDashboardLayout.classList.remove('hidden');
                
                if(reps > 0) showToast(`Sesi terekam! Anda menyelesaikan ${reps} repetisi.`);
            }

            btnsStartExercise.forEach(btn => btn.addEventListener('click', startAIExercise));
            if(btnStopExercise) btnStopExercise.addEventListener('click', stopAIExercise);
            if(btnStopExerciseTop) btnStopExerciseTop.addEventListener('click', stopAIExercise);
        });
    </script>
